    ...
    return (
        ...
        <div className="text-center mt-12 text-[rgb(220,20,60)]">
            ...
            <div className="flex flex-row justify-center mb-32 gap-4 p-3">
                <a href="/mechanics" className="bg-[rgb(139,0,0)] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[rgb(255,0,0)] transition-all">Get a Mechanic</a>
                <a href="/carwashers" className="bg-[rgb(139,0,0)] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[rgb(255,0,0)] transition-all">Get a Carwasher</a>
            </div>
